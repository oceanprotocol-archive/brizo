...
#         agreement_id, ddo.asset_id, consumer_account.address, publisher_account.address, publisher_ocean_instance._keeper)
#
#     Brizo.set_http_client(client)
#     # subscribe to events
#     register_service_agreement_consumer(os.path.join(tempfile.gettempdir(), 'temp_squid_py.db'),
